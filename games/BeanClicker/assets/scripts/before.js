...
j( function() {
		...
		j("#plantation").tooltip({position: { my: "right center", at: "left center", collision: "none"},content: '<img src="assets/images/plantation.jpg" style="margin-left: 42%; margin-right: auto; margin-bottom: 5px; height: auto; border: 1px solid black;"/><br />Generates 10 Beans every 10 seconds.'});
		...
		j("#upgradedPlantation").tooltip({position: { my: "right center", at: "left center", collision: "none"},content: '<img src="assets/images/upgradedPlantation.jpg" style="margin-left: 42%; margin-right: auto; margin-bottom: 5px; height: auto; border: 1px solid black;"/><br />Generates 50 Beans every 10 seconds.<br /><span style="color: red;">Requires at least one plantation.</span>'});
